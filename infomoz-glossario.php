...
?>
        <div style="float:right;width: 220px; border: 1px dotted blue;">
            <h2>Powered by</h2>
            <img src="<?php echo get_option ( 'siteurl' ) ; ?>/wp-content/plugins/infomoz-glossario/images/hostmoz.png" width="140px" style="padding: 5px" alt="Hospedagem de Sites de Moçcambique"/>
            <img src="<?php echo get_option ( 'siteurl' ) ; ?>/wp-content/plugins/infomoz-glossario/images/gringo.png" width="140px" style="padding: 5px" alt="GRINGO Jeans"/>
            <img src="<?php echo get_option ( 'siteurl' ) ; ?>/wp-content/plugins/infomoz-glossario/images/infomoz.gif" width="140px" style="padding: 5px" alt="Informática Moçambique"/>
        </div>
    <div class="wrap">
...
?>
	    ...
	    <tr>
            <th align="left" scope="col"><br><?php echo __ ( 'Term'       ) ; ?><br/></th>
            <th align="left" scope="col"><br><?php echo __ ( 'Definition' ) ; ?><br/></th>
            <th colspan="2"><br><?php echo __ ( 'Actions'     ) ; ?><br></th>
    	</tr>
...
?>
        ...
        <tr id="cat-<?php echo $Term['ID'] ; ?>" class="<?php echo $Class ; ?>">
            <td valign="top"><?php echo $Term['Title'] ; ?></td>
            <td valign="top"><?php echo $Term['Definition'] ; ?></td>
            <td valign="top"><?php echo $Edit ; ?></td>
            <td valign="top"><?php echo $Delete ; ?></td>
    	</tr>
